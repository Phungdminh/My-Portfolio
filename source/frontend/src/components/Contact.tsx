...
function getIcon(label: string, href: string): ReactNode {
  ...
  if (key.includes('telegram') || key.includes('t.me')) {
    return (
      <path d="M21.6 4.2 18.8 19a1.2 1.2 0 0 1-1.9.72l-4.12-3.04-2.02 1.95a1 1 0 0 1-1.7-.52l-.7-4.36-3.95-1.27c-1.02-.33-1.06-1.76-.06-2.14L20.1 3.25c.9-.34 1.7.15 1.5.95ZM9.35 13.03l.48 2.99.14-.02.17-1.55 7.78-7.02c.34-.31-.07-.46-.52-.18l-9.6 6.04 1.55-.26Z" />
    );
  }
  if (key.includes('facebook')) {
    return (
      <path d="M14 8.2V6.7c0-.73.24-1.2 1.24-1.2H17V2.2A23.7 23.7 0 0 0 14.42 2C11.86 2 10.1 3.56 10.1 6.42V8.2H7.2V12h2.9v10H14V12h2.95l.47-3.8H14Z" />
    );
  }
  if (key.includes('zalo')) {
    return (
      <path d="M5 4h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-5.6L9 21v-4H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Zm1.4 3v2h3.1l-3.3 4.1V15h5v-2H8.1l3.3-4.1V7h-5Zm7.3 8h2V7h-2v8Zm3.1 0h1.9v-2.1h-1.9V15Z" />
    );
  }
